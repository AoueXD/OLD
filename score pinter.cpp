...
int main(){
	...
	ExamRecord *student;
	ExamRecord *AddStudent;
	ExamRecord *NewStudent;
	int i, j, size, size2;
	...
	cout << "Add some student: " << endl;
	cin >> size2;
	for(i = 1; i <= size2; i++) {
		AddStudent -> AddStudent(size + i);
	}
	
	NewStudents = new ExamRecord[size + size2];
	...
	NewStudent[size + size2] = *AddStudent;
